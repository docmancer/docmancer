...
- **Settings** chooses a provider and model, manages local credentials, controls capture, and shows optional Cloud status.
...
- Capture is a separate opt-in and never turns on merely because an agent was connected.
