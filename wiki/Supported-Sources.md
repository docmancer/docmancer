...
Project Shared Memory is ordinary Markdown under `<project>/.docmancer/tree`. The automatically combined machine-wide tree is under `~/.docmancer/tree`. Both retain provenance and stable addresses. Guarded existing-file mutations use content hashes.
